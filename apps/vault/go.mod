module github.com/runtime-sh/runtime/apps/vault
...
require (
	...
	github.com/runtime-sh/runtime/packages/schema v0.0.0-00010101000000-000000000000
	github.com/runtime-sh/runtime/packages/theme v0.0.0
	github.com/runtime-sh/runtime/packages/tui v0.0.0
	github.com/runtime-sh/runtime/packages/validation v0.0.0
...
replace (
	...
	github.com/runtime-sh/runtime/packages/validation => ../../packages/validation
)
