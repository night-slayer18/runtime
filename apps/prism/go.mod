module github.com/runtime-sh/runtime/apps/prism
...
require (
	...
	github.com/runtime-sh/runtime/packages/tree v0.0.0
...
replace (
	...
	github.com/runtime-sh/runtime/packages/tree => ../../packages/tree
